...
QT_MOC_LITERAL(1, 7, 19), // "toggleSwitchClicked"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 16), // "processOnClicked"
QT_MOC_LITERAL(4, 45, 5), // "state"
QT_MOC_LITERAL(5, 51, 6), // "offset"
QT_MOC_LITERAL(6, 58, 5) // "brush"

    },
    "Switch\0toggleSwitchClicked\0\0"
    "processOnClicked\0state\0offset\0brush"
};
...
void Switch::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->toggleSwitchClicked(); break;
        case 1: _t->processOnClicked((*reinterpret_cast< bool(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Switch::toggleSwitchClicked)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Switch::toggleSwitchClicked()
{
